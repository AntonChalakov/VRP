class TechApp extends ConnectionListener
{
	constructor(connection, data_model, busy)
	{
		...
		this._NavBar.add(new WelcomePage(this._data, evdev));
		this._NavBar.add(new FaultsPage(this._data, evdev));
		this._NavBar.add(new AppointmentPage(this._data, evdev));
